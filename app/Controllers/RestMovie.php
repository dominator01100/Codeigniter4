...
class RestMovie extends MyRestApi {
    ...
    public function paginate() {
        $movieImage = $this->model->asObject()->select('movies.*, categories.title as category, any_value(movie_images.image) as image')->join('categories', 'categories.id = movies.category_id')->join('movie_images', 'movies.id = movie_id', 'left')->groupBy('movies.id');
